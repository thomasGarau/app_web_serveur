...
const { verifyTokenBlacklist, verifyAuthorisation, verifyOwner, verifyState } = require('../middlewares/verifyAuthorisation.js');
const { validateField, handleValidationErrors, validateObjectSchema } = require('../middlewares/sanitizeInput.js');
const {annotationConfig, closeAnnotationConfig, answerToAnnotationConfig, closeAnswerToAnnotationConfig, verifyAnnotationStateConfig} = require('../middlewares/objectConfig.js');
...
router.post('/add-answer', [validateObjectSchema(answerToAnnotationSchema), handleValidationErrors, verifyAuthorisation, verifyTokenBlacklist, verifyState(verifyAnnotationStateConfig, "annotation")], addAnswerToAnnotation);
