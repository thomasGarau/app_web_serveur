...
router.post('/add-cours', [validateField('id_study','label','id_theme'), verifyTokenBlacklist,validate], addcours);
router.post('/update-cours',[validateField('id_study','label','id_theme'),verifyTokenBlacklist,validate], updatecours);
