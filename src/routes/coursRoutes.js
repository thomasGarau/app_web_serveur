...
router.get('/cours-id',[validateField('id_study'), verifyAuthorisation, verifyTokenBlacklist], courById);

router.post('/add-cours', [validateField('id_study','label','contenu','id_chapitre'), verifyAuthorisation, verifyTokenBlacklist], addcours);
router.post('/update-cours',[validateField('id_study','label','contenu','id_chapitre'),verifyAuthorisation, verifyTokenBlacklist,verifyOwner(ueConfig,"id_study")], updatecours); // role admin ou reservé au créateur?
router.post('/delete-cours',[validateField('id_study'),verifyAuthorisation, verifyTokenBlacklist,verifyIsTeacher], deletecours);// role admin ou reservé au créateur?
