...
router.post('/add-message', [verifyAuthorisation, verifyTokenBlacklist, validateField('contenu','date','id_forum','heure'), handleValidationErrors], addMessage);
router.post('/update-message', [verifyAuthorisation, verifyTokenBlacklist,validateField('id_message','contenu','date','heure','id_forum'), handleValidationErrors,  verifyOwnerOrAdmin], updateMessage);
...
router.post('/creer-forum', [verifyAuthorisation, verifyTokenBlacklist, validateField('label','date','etat','id_utilisateur'), handleValidationErrors], addForum);
router.post('/update-forum', [verifyAuthorisation, verifyTokenBlacklist, validateField('id_forum','label','date','etat','id_utilisateur'), handleValidationErrors, verifyOwnerOrAdmin], updateForum);
