...
const { forumListCours,forumListQuizz,messageList,messageListQuizz,messageListCours,messageListCoursChapitre, addMessage, updateMessage, deleteMessage,forumListChapitre,forumList,addForumCours,addForumQuizz,updateForum,deleteForum } = require('../controllers/chat-controllers');
