...
const { verifyTokenBlacklist, verifyAuthorisation, verifyOwner, verifyVisibility, verifyIsAdministration } = require('../middlewares/verifyAuthorisation.js');
...
const {allFlashcard, userFlashcard, dailyFlashcard, flashcardAnswer, addToCollection, removeFromCollection, createFlashcard, updateFlashcard, deleteFlashcard, GenerateDailyFlashcard} = require('../controllers/flashcard-controller');
...
router.get('/generate-daily-flashcards', [verifyAuthorisation, verifyTokenBlacklist, verifyIsAdministration], GenerateDailyFlashcard);
