...
router.post('/create-cm', [validateObjectSchema(carteMentaleSchema), handleValidationErrors, verifyAuthorisation, verifyTokenBlacklist, uploadImage], createCM);
router.put('/update-cm', [validateObjectSchema(updateCarteMentaleSchema), handleValidationErrors, verifyAuthorisation, verifyTokenBlacklist, verifyOwner(cmConfig, "cm"), uploadImage], updateCM);
