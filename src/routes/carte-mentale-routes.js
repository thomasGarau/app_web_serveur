...
const {userCM, allCMChapter, cmInfo, cmDetails, createCM, updateCM, deleteCM, addToCollection, removeFromCollection} = require('../controllers/flashcard-controller');
...
router.post('/create-cm', [validateObjectSchema(carteMentaleSchema), handleValidationErrors, verifyAuthorisation, verifyTokenBlacklist], createCM);
router.put('/update-cm', [validateObjectSchema(updateCarteMentaleSchema), handleValidationErrors, verifyAuthorisation, verifyTokenBlacklist, verifyOwner(cmConfig, "cm")], updateCM);
